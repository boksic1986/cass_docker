...
class CassPipe(object):
    ...
    def __init__(self, input_path, output_path, config_path=None):
        ...
        self._pipe = self.config_path['pipe_path'] if config_path else '/project/BIT/chenjc/CASS'
...
def get_parser():
    ...
    parser.add_argument("-j", "--json", metavar="CONFIG FILE", dest='json', required=True)
...
# file = '/project/BIT/chenjc/tmps/dataset/S4-En-UniSeqEn-NS_S3.bam'
# a = CassPipe(file, '/project/BIT/chenjc/tmps/dataset/test', './config.json')
# a.drop_dup()
# a.ca_cnv()
# a.segment()
# a.draw_pic()
